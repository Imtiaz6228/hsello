...
import { availabilitySchema, changePasswordSchema, forgotPasswordSchema, loginSchema, registerSchema, resendVerificationSchema, resetPasswordSchema, verifyEmailSchema } from "../schemas/auth.schemas.js";
import { changePassword, getAvailability, getCurrentUser, getRefreshTokenFromRequest, loginUser, logoutUser, refreshUserSession, registerUser, requestPasswordReset, resendVerification, resetPassword, verifyEmailToken } from "../services/auth.service.js";
...
authRouter.post("/register", authLimiter, imageUpload.single("profilePicture"), asyncHandler(async (req, res) => {
...
authRouter.post("/change-password", requireAuth, requireVerifiedUser, sensitiveLimiter, asyncHandler(async (req, res) => {
