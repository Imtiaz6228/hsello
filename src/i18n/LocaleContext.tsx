...
const copy: Record<LocaleCode, Record<string, string>> = {
  en: {
    ...
    homeEyebrow: "THE PREMIUM DIGITAL MARKETPLACE", homeTitleA: "Everything digital.", homeTitleB: "One trusted place.", homeIntro: "Discover exceptional digital products, tools and services from verified sellers—delivered fast and protected from checkout to completion.", homeSearch: "What are you looking for?", searchMarketplace: "Search marketplace", shopByCategory: "Shop by category", popularNow: "Popular right now", newArrivals: "New arrivals", menu: "Menu", close: "Close"
  },
  "zh-CN": {
